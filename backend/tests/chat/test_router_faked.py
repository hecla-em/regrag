"""Chat SSE endpoint over a faked search and a faked ledger: payload shapes and the error
path. test_router streams over the real ones, and this module shrinks into it."""
...
pytestmark = pytest.mark.usefixtures("recorded_requests", "no_tool_session")
