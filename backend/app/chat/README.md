...
| `done` | last, on a completed stream | the thread id the turn was recorded under, which a follow-up sends back as `thread_id`, and the request id, which a vote names |
